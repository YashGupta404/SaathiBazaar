...
      // Send back the user's MongoDB _id along with the success message
      res.status(200).send({
        message: 'Logged in successfully!',
        userId: user._id, // <<<<< ADDED: The user's MongoDB _id
        user: user // Optional: sending full user object can be useful too
      });
    } catch (error) {
